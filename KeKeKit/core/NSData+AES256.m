...
+ (NSString *)AES256EncryptWithPlainText:(NSString *)plain pwd:(NSString*)pwd
{
    ...
    CCCryptorStatus cryptStatus = CCCrypt(kCCEncrypt, kCCAlgorithmAES128,kCCOptionPKCS7Padding,
                                          [[NSData AESKeyForPassword:pwd] bytes], kCCKeySizeAES256,
...
+ (NSString *)AES256DecryptWithCiphertext:(NSString *)ciphertexts pwd:(NSString*)pwd
{
...
+ (NSString *)AES256EncryptWithPlainText:(NSString *)plain {
    return [self AES256EncryptWithPlainText:plain pwd:PASSWORD];
}

/*解密方法*/
+ (NSString *)AES256DecryptWithCiphertext:(NSString *)ciphertexts{
    return [self AES256DecryptWithCiphertext:ciphertexts pwd:PASSWORD];
