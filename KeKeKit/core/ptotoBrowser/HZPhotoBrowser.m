...
- (void)layoutSubviews
{
    ...
    _indexLabel.center = CGPointMake(self.bounds.size.width * 0.5, kStatusBarHeight);
    ...
    if (UIDeviceOrientationIsLandscape(orientation)) {
        if (self.bounds.size.width < self.bounds.size.height) {
            ...
            [UIView animateWithDuration:kRotateAnimationDuration delay:0.0f options:UIViewAnimationOptionBeginFromCurrentState animations:^{
                ...
                if (iPhoneX) {
                    ...
                    self.bounds = CGRectMake(0, 0,  KAppHeight - kStatusBarHeight - kHomeBarHeight, kAPPWidth);
                } else {
        ...
        if (self.bounds.size.width > self.bounds.size.height) {
            ...
            [UIView animateWithDuration:kRotateAnimationDuration delay:0.0f options:UIViewAnimationOptionBeginFromCurrentState animations:^{
                ...
                if (iPhoneX) {
                    self.bounds = CGRectMake(0, 0, kAPPWidth, KAppHeight - kStatusBarHeight - kHomeBarHeight);
                } else {
...
- (void)show
{
    ...
    if (iPhoneX) {
        self.frame = CGRectMake(0, kStatusBarHeight,kAPPWidth,KAppHeight - kStatusBarHeight - kHomeBarHeight);
    } else {
