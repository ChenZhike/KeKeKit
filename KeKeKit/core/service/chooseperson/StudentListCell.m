...
-(void)initUI{
    ...
    UINib*nib=[UINib nibWithNibName:NSStringFromClass([StuCollectionViewCell class]) bundle:nil];
    [mainCollectionView registerNib:nib forCellWithReuseIdentifier:@"StuCollectionViewCell"];
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(StuCollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (self.openSel) {
        cell.selB.hidden=NO;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    StuCollectionViewCell*cell=[collectionView dequeueReusableCellWithReuseIdentifier:@"StuCollectionViewCell" forIndexPath:indexPath];
