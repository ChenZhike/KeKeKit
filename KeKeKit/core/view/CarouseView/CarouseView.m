...
@property (nonatomic, strong) MyPageControl *pageControl;  // 分页控件
...
- (UIPageControl *)pageControl
{
    ...
    {
        // 设置尺寸，坐标，注意纵坐标的起点
    CGFloat _pageControlH=30;
        _pageControl = [[MyPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height - _pageControlH, self.frame.size.width, _pageControlH)];
        // 设置页面数
        _pageControl.numberOfPages = _pageCount;
        // 设置当前页面索引
        _pageControl.currentPage = 0;
        // 设置未被选中时小圆点颜色
        _pageControl.pageIndicatorTintColor = [[UIColor blackColor]colorWithAlphaComponent:0.1];
        // 设置被选中时小圆点颜色
